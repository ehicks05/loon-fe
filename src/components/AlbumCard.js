...
export default function AlbumCard(props) {
  ...
  const imageUrl = album.albumImageId
    ? `https://res.cloudinary.com/ehicks/image/upload/${album.albumImageId}`
    : placeholder;
  ...
  const linkAlbumArtist = appContext.distinctArtists.includes(
    album.albumArtist
  );
